...
public class SecuredAltTest extends SecuredContainerTest {
	...
	public void testSetDefaultBoolean() {
		testSetDefault( (b)->getSecuredAlt().setDefault(b.booleanValue()),
				()->alt.getDefaultBoolean(), Boolean.TRUE );
	}

	@Test
	public void testSetDefaultChar() {
		testSetDefault( (b)->getSecuredAlt().setDefault(b),
				()->alt.getDefaultChar(), 'c' );
	}

	@Test
	public void testSetDefaultDouble() {
		testSetDefault( (b)->getSecuredAlt().setDefault(b),
				()->alt.getDefaultDouble(), Double.valueOf( 3.14d) );
	}

	@Test
	public void testSetDefaultFloat() {
		testSetDefault( (b)->getSecuredAlt().setDefault(b),
				()->alt.getDefaultFloat(), Float.valueOf( 3.14f) );
	}

	@Test
	public void testSetDefaultLong() {
		testSetDefault( (b)->getSecuredAlt().setDefault(b),
				()->alt.getDefaultLong(), Long.valueOf( 2L) );
	}
	...
	public void testSetDefaultResource() {
		...
		testSetDefault( (b)->getSecuredAlt().setDefault(b),
				()->alt.getDefaultResource(), expected );
	}

	@Test
	public void testSetDefaultString() {
		testSetDefault( (b)->getSecuredAlt().setDefault(b),
				()->alt.getDefaultString(), "Test" );
	}
